...
declare namespace $ {
	...
	export class $okei_mentor_button extends $mol_button_minor {
		icon( ): any
	}
...
//# sourceMappingURL=button.view.tree.d.ts.map
declare namespace $.$$ {
    class $okei_mentor_button extends $.$okei_mentor_button {
        sub(): readonly ($mol_view_content)[];
    }
}
...
declare namespace $ {
	...
	export class $okei_mentor_page extends $mol_page {
		Head( ): any
	}
...
declare namespace $ {
	...
	type $mol_string__hint_okei_mentor_1 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_string['hint'] >
	>
	type $okei_mentor_button__title_okei_mentor_2 = $mol_type_enforce<
		string
		,
		ReturnType< $okei_mentor_button['title'] >
	>
	type $okei_mentor_button__icon_okei_mentor_3 = $mol_type_enforce<
		ReturnType< $okei_mentor['Add_source_icon'] >
		,
		ReturnType< $okei_mentor_button['icon'] >
	>
	type $okei_mentor_page__title_okei_mentor_4 = $mol_type_enforce<
		string
		,
		ReturnType< $okei_mentor_page['title'] >
	>
	type $okei_mentor_page__foot_okei_mentor_5 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $okei_mentor_page['foot'] >
	>
	export class $okei_mentor extends $mol_book2_catalog {
		Theme( ): $mol_theme_auto
		Lights( ): $mol_lights_toggle
		Message_input( ): $mol_string
		Add_source_icon( ): $mol_icon_arrow_up
		Send_button( ): $okei_mentor_button
		Chat( ): $okei_mentor_page
		title( ): string
		menu_title( ): ReturnType< $okei_mentor['title'] >
		plugins( ): readonly(any)[]
		menu_foot( ): readonly(any)[]
		spreads( ): ({ 
			'chat': ReturnType< $okei_mentor['Chat'] >,
		}) 
		Placeholder( ): any
	}
...
//# sourceMappingURL=mentor.view.tree.d.ts.map
declare namespace $ {
}
