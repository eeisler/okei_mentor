...
;
	($.$okei_mentor_button) = class $okei_mentor_button extends ($.$mol_button_minor) {
		icon(){
			return null;
		}
	};
...
(function ($) {
    ...
    (function ($$) {
        ...
        $$.$okei_mentor_button = $okei_mentor_button;
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));
...
var $;
(function ($) {
    $mol_style_attach("okei/mentor/button/button.view.css", "");
})($ || ($ = {}));

;
	($.$okei_mentor_page) = class $okei_mentor_page extends ($.$mol_page) {
		Head(){
			return null;
		}
	};
...
var $;
(function ($) {
    $mol_style_attach("okei/mentor/page/page.view.css", "[okei_mentor_page] {\r\n\tflex-basis: 50rem;\r\n    background-color: var(--mol_theme_back);\r\n    box-shadow: none;\r\n}");
})($ || ($ = {}));
...
;
	($.$okei_mentor) = class $okei_mentor extends ($.$mol_book2_catalog) {
		Theme(){
		...
		Send_button(){
			const obj = new this.$.$okei_mentor_button();
			(obj.title) = () => ("");
			(obj.icon) = () => ((this.Add_source_icon()));
			return obj;
		}
		Chat(){
			const obj = new this.$.$okei_mentor_page();
			(obj.title) = () => ("Чат");
			(obj.foot) = () => ([(this.Message_input()), (this.Send_button())]);
			return obj;
		}
		title(){
			return "AI Mentor";
	...
	($mol_mem(($.$okei_mentor.prototype), "Theme"));
	($mol_mem(($.$okei_mentor.prototype), "Lights"));
	($mol_mem(($.$okei_mentor.prototype), "Message_input"));
	($mol_mem(($.$okei_mentor.prototype), "Add_source_icon"));
	($mol_mem(($.$okei_mentor.prototype), "Send_button"));
	($mol_mem(($.$okei_mentor.prototype), "Chat"));
...
var $;
(function ($) {
    $mol_style_attach("okei/mentor/mentor.view.css", ":root {\r\n\t/* отключение подсветки тапов на мобильных устройствах */\r\n\t-webkit-tap-highlight-color: transparent;\r\n    --mol_theme_hue_spread: 525deg;\r\n}\r\n\r\n[okei_mentor_page] {\r\n\tmargin-right: auto;\r\n    margin-left: auto;\r\n}\r\n\r\n[okei_mentor_menu] {\r\n\tflex-basis: 20em;\r\n\tmargin-left: 0;\r\n}\r\n\r\n[mol_book2] > *:not(:first-of-type):before,\r\n[mol_book2] > *:not(:last-of-type)::after {\r\n\tbackground: none;\r\n}\r\n");
})($ || ($ = {}));
